...
async fn validate_credentials(
    ...
    .await
    .context("Failed to apawn blocking task.")
    .map_err(PublishError::UnexpectedError)??;
...
#[tracing::instrument(
    ...
    skip(body, pool, email_client, requst),
...
pub async fn publish_newsletter(
    ...
    let credentials = basic_authentication(requst.headers()).map_err(PublishError::AuthError)?;
    tracing::Span::current().record("user_name", &tracing::field::display(&credentials.username));
